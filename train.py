...
class DataGenerator(keras.utils.Sequence):
    """Data generator class for keras fit_generator"""
    ...
    def on_epoch_end(self):
        """Shuffle image index on the end of each epoch."""
        if self.shuffle:
...
def _main():
    ...
    # First stage of training. Freeze darknet weights.
    ...
    # Second stage of training. Set all weights trainable.
